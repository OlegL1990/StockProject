...
import com.olegluzin.moexservice.exception.BondParsingException;
...
@Service
@Slf4j
public class MoexXmlToBondsParser implements Parser{
        @Override
        public List<BondDto> parse(String bondsAsString) {
                ...
                try {
                        ...
                        try (var reader = new StringReader(bondsAsString)) {
                        ...
                        log.error("xml parsing error, xml:{}", bondsAsString, ex);
